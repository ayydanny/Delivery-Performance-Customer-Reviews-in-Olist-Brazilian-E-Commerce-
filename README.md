...
**This project explores what determines low vs. high customer reviews by exploring two main factors, geolocation and sellers, with a supporting variable, delivery time, which includes delivery delay days and approval time hours. This project included SQL for queries and feature engineering, Python (Pandas) for data inspection, Excel for storage of final data and a dashboard of sellers, and a Tableau dashboard of geolocation.**  
